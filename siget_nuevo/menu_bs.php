 ...
 <div class="container-fluid" >
   ...
   <?php 
    if (isset($_SESSION['username']) && $_SESSION['rol']=='preceptor'){
      ?>
    <li><a href="abm_mR.php">Mesa Regular</a></li>
    <li><a href="abm_mP.php">Mesa Previa</a></li>
    <li><a href="abm_ads.php">Equivalencia</a></li>
     <?php
      }
    ?>
...
<?php
	  if (!isset($_SESSION['username'])){
        echo '	  
	        <li><a href="login.php" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-log-in"></span> Ingresar</a></li>
             ';
		  }	 
	  else{
	    echo '	  
