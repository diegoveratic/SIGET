...
if (!empty($_POST)) {
	...
	if ($operacion == 'alta' && !isset($_GET['id_est'])){
		...
		$estudiante->legajo=$_POST['txtLegajo'];
		$estudiante->edad=$_POST['txtEdad'];
		$estudiante->nacionalidad=$_POST['txtNacionalidad'];
		$estudiante->guardar();
	}
}
?>
...
<div class="row" >
  ...
  <legend>Agregar estudiante</legend>
	 ...
	 <div class="row">		
		...
		<div class="col-xs-12">
			  <div class="form-group">
				<label for="ejemplo_Matricula">nº Legajo</label>
				<input type="text"  size="20" name="txtLegajo" class="form-control" id="ejemplo_Matricula"
					   placeholder="Introduce el nº Legajo" />
			  </div> 
		</div> 
 ...
 <div class="row">		
		<div class="col-xs-12">
			  <div class="form-group">
				<label for="ejemplo_Matricula">Edad</label>
				<input type="text"  size="20" name="txtEdad" class="form-control" id="ejemplo_Matricula"
 ...
 <div class="row">		
		<div class="col-xs-12">
			  <div class="form-group">
				<label for="ejemplo_Matricula">Nacionalidad</label>
				<input type="text"  size="20" name="txtNacionalidad" class="form-control" id="ejemplo_Matricula"
