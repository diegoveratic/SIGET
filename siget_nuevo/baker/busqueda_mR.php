...
if ($consulta_por == 'nada') {
	$mesa=mesaRegular::mostrar_todos();
} elseif ($consulta_por == 'mate') {
	$mesa=mesaRegular::buscarmate($str_b);
} elseif ($consulta_por == 'profe') {
	$mesa=mesaRegular::buscarprofe($str_b);
} elseif ($consulta_por == 'anio') {
	$mesa=mesaRegular::buscaranio($str_b);
} else {
