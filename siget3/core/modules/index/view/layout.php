    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">SIGET <sup><small><span class="label label-success"></span></small></sup> </a>
        </div>
...
?>
          ...
          <li><a href="index.php?view=team&id=<?php echo $_SESSION["selected_id"];?>"><i class="fa fa-dashboard"></i>Panel de Administracion</a></li>
          ...
          <li>  <a href="index.php?view=boletinalumno&id=<?php echo $_SESSION["selected_id"]; ?>"><i class='fa fa-check'></i> Boletin</a></li>
		  <?php if ($u->is_admin){?> <li>  <a href="index.php?view=newuser&team_id=<?php echo $_SESSION["selected_id"]; ?>"><i class='fa fa-tasks'></i> Registro de Profesores</a></li><?php } ?>
          <li class="dropdown">
              ...
              <ul class="dropdown-menu">
				...
				<?php if ($u->is_admin){?> <li><a href="index.php?view=users&team_id=<?php echo $_SESSION["selected_id"]; ?>">Profesores Registrados</a></li><?php } ?>
              </ul>
            </li>
          <?php endif; ?>
          <li><a href="index.php?view=teams"><i class="fa fa-users"></i> Cursos</a></li>
          <?php if($u->is_admin):?>
...
<hr>
<p>EEST N°4 Grupo de desarrollo Alemis - Arroyo - Bogado (Evilnapsis) &copy; 2017</p>
